...
public class RSAUtils {
    ...
    public String encryptByPubKey(String original, String publicKeyStr) {
        ...
        try {
            ...
            int maxEncryptSize = keyPair.getMaxEncryptSize();//RSA最大加密明文大小
     ...
     * @return 密文
     */
    public String encryptByPriKey(String original, String privateKeyStr) {
        String prefixStr = "【私钥加密】";
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        try {
            if (StringUtils.isEmpty(privateKeyStr)) {
                log.info("{}失败，privateKeyStr为空", prefixStr);
     ...
     * @return 明文
     */
    public String decryptByPubKey(String ciphertext, String publicKeyStr) {
        String prefixStr = "【公钥解密】";
        ByteArrayOutputStream out = new ByteArrayOutputStream();
        try {
            if (StringUtils.isEmpty(publicKeyStr)) {
                log.info("{}失败，publicKeyStr为空", prefixStr);
